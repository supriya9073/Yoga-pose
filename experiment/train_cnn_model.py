...
from models_cnn import get_model # This will get our Multimodal QuadtreeCNN
from dataloader_cnn import get_dataloaders, IMAGE_SIZE # YogaPoseFrameDataset is used internally by get_dataloaders

# --- Configuration (Hyperparameters & Paths) ---
# This MUST point to the output of your '1_prepare_still_image_dataset.py' script!
...
TRAINING_MODE = 'numerical_only' # <<< CHANGE THIS FOR EACH EXPERIMENT
